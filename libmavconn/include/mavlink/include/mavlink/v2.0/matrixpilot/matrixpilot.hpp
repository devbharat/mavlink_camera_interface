...
enum class MAV_CMD
{
    ...
    VIDEO_START_CAPTURE=2500, /* Starts video capture |Camera ID (0 for all cameras), 1 for first, 2 for second, etc.| Frames per second| Resolution in megapixels (0.3 for 640x480, 1.3 for 1280x720, etc), set to 0 if param 4/5 are used| WIP: Resolution horizontal in pixels| WIP: Resolution horizontal in pixels|  */
    VIDEO_STOP_CAPTURE=2501, /* Stop the current video capture |WIP: Camera ID| Reserved|  */
...
#include "./mavlink_msg_serial_udb_extra_f17.hpp"
#include "./mavlink_msg_serial_udb_extra_f18.hpp"
#include "./mavlink_msg_serial_udb_extra_f19.hpp"
#include "./mavlink_msg_serial_udb_extra_f20.hpp"
#include "./mavlink_msg_serial_udb_extra_f21.hpp"
#include "./mavlink_msg_serial_udb_extra_f22.hpp"
